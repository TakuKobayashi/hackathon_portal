module ApplicationHelper
  def event_blogger_html_field(event)
    ...
    html_arr << content_tag('div', event.generate_google_map_embed_tag) if event.lat.present? && event.lon.present?
    html_arr << content_tag('div', "定員#{event.limit_number}人") if event.limit_number.present?
