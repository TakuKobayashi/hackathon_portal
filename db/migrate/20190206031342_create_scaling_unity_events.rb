class CreateScalingUnityEvents < ActiveRecord::Migration[5.2]
  def change
    create_table :scaling_unity_events do |t|
      ...
      t.binary :location_image_binary, :limit => 1600.kilobyte
      t.timestamps
    end
    add_index :scaling_unity_events, [:event_id, :type], unique: true
    add_index :scaling_unity_events, [:started_at, :ended_at]
